...
abstract class AbstractRepository implements RepositoryContract
{
    ...
    /**
     * Menetapkan susunan item ke daftar keinginan.
     *
     * @param  array $with
     *
     * @return self
    ...
    /**
     * Digunakan untuk contoh baru dari entitas yang akan di Queri.
     */
    ...
    /**
     * Mendapatkan hasil menurut halaman.
     *
     * @param  int $limit
     * @param  int $page
     * @param  array $columns
    ...
    /**
     * Mencari banyak hasil dengan kunci dan nilai.
     *
     * @param  string $key
     * @param  mixed $value
     * @param  array $columns
    ...
    /**
     * Mencari satu hasil dengan kunci dan nilai.
     *
     * @param  string $key
     * @param  mixed $value
     * @param  array $columns
    ...
    /**
     * Mendapatkan hasil akhir terakhir dengan kunci dan nilai.
     *
     * @param       $key
     * @param       $value
     * @param array $columns
    ...
    /**
     * Mencari banyak hasil dimana kunci berada dalam array.
     *
     * @param  string $key
     * @param  array $array
     * @param  array $columns

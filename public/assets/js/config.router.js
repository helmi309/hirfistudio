...
function ($stateProvider, $urlRouterProvider, $controllerProvider, $compileProvider, $filterProvider, $provide, $ocLazyLoadProvider, jsRequires) {
    ...
    // Url cru spl table
        .state('app.spl', {
            url: '/spl/:id',
            templateUrl: 'assets/src/spl/spl-list.html',
            title: 'Data Spl',
            resolve: loadSequence('SplCtrl', 'spl_service'),
        })

        .state('app.spl-create', {
            url: '/spl-create/:id',
            templateUrl: 'assets/src/spl/spl-create.html',
            title: 'Create Data Spl',
            resolve: loadSequence('SplCreateCtrl', 'spl_service','ngImgCrop'),
        })

        .state('app.spl-edit', {
            url: '/spl-edit/:id',
            templateUrl: 'assets//src/spl/spl-edit.html',
            title: 'Edit Data Spl',

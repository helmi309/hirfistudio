$(document).ready(function () {      
    ...
    function init_template(){//Class is vital to run AJAX Pages 
        ...
        $('.open-scrolling-menu').click(function(){
            ...
            $('.scrolling-menu').toggleClass('scrolling-menu-hidden'); 
            $(this).toggleClass('rotate-icon');
            $(this).addClass('transition-icon');
        });
        
        if($('.scrolling-menu').hasClass('scrolling-menu-hidden')){
            $('.open-scrolling-menu').addClass('rotate-icon');   
        }       
        
        if($('.scrolling-menu').hasClass('scrolling-menu-static')){
            $('.open-scrolling-menu').hide(0);   
        }
        
        $('.open-header-menu').click(function(){
            $('.header-icon-2, header-icon-3, .header-icon-4').addClass('no-pointer-events opacity-25');
            $('.header-menu').addClass('pointer-events');
            $(this).stop(0,0).hide(0);
            $('.close-header-menu').addClass('no-pointer-events');
            $('.close-header-menu').stop(0,0).show(0);
            $('.close-header-menu .line-1').addClass('line-1-active');
            $('.close-header-menu .line-2').addClass('line-2-active');
            $('.close-header-menu .line-3').addClass('line-3-active');
            
            setTimeout(function(){
                $('.close-header-menu').removeClass('no-pointer-events');
            },400);
            
            var bg_height = $(window).height();
            $('.header-menu-background').css({
                "height": bg_height,
                "transform": "translateY("+bg_height*2+"px) scale(1, 1)", 
                "-webkit-transform": "translateY("+bg_height*2+"px) scale(1, 1)", 
                "-moz-transform": "translateY("+bg_height*2+"px) scale(1, 1)", 
                "-o-transform": "translateY("+bg_height*2+"px) scale(1, 1)",
                "-ms-transform": "ranslateY("+bg_height*2+"px) scale(1, 1)",
                "opacity":"1"
            });
            ...
            $('.header-menu a').each(function(i){
                ...
                setTimeout(function() {
                    row.css({
                        "transform": "translateX("+0+"px) translateY("+0+"px) scale(1, 1)", 
                        "-webkit-transform": "translateX("+0+"px) translateY("+0+"px) scale(1, 1)", 
                        "-moz-transform": "translateX("+0+"px) translateY("+0+"px) scale(1, 1)", 
                        "-o-transform": "translateX("+0+"px) translateY("+0+"px) scale(1, 1)",
                        "-ms-transform": "translateX("+0+"px) translateY("+0+"px) scale(1, 1)",
                        "opacity":"1"
                    });
                }, 50*i);
            });
            $('.header-menu-background').addClass('active-header-background');
            $('.header-menu-close').addClass('pointer-events');
        });         
        
        $('.close-header-menu').click(function(){
            $('.header-icon-2, header-icon-3, .header-icon-4').removeClass('no-pointer-events opacity-25');
            $('.header-menu').removeClass('pointer-events');
            $(this).stop(0,0).delay(250).hide(0);
            $('.open-header-menu').addClass('no-pointer-events');
            $('.open-header-menu').stop(0,0).delay(250).show(0);
            $('.close-header-menu .line-1').removeClass('line-1-active');
            $('.close-header-menu .line-2').removeClass('line-2-active');
            $('.close-header-menu .line-3').removeClass('line-3-active');
            
            setTimeout(function(){
                $('.open-header-menu').removeClass('no-pointer-events');
            },400);
            
            var bg_height = ($(window).height())*(-1);
            setTimeout(function(){
            $('.header-menu-background').css({
                "height": bg_height,
                "transform": "translateY("+bg_height*2+"px) scale(1, 1)", 
            ...
            $('.header-menu a').each(function(i){
                ...
                setTimeout(function() {
                    row.css({
                        "transform": "translateX("+i*(-3)+"px) translateY("+i*(-4)+"px) scale(1.05, 1.05)", 
                        "-webkit-transform": "translateX("+i*(-3)+"px) translateY("+i*(-4)+"px) scale(1.05, 1.05)", 
                        "-moz-transform": "translateX("+i*(-3)+"px) translateY("+i*(-4)+"px) scale(1.05, 1.05)", 
                        "-o-transform": "translateX("+i*(-3)+"px) translateY("+i*(-4)+"px) scale(1.05, 1.05)",
                        "-ms-transform": "translateX("+i*(-3)+"px) translateY("+i*(-4)+"px) scale(1.05, 1.05)",
                        "opacity":"0"
                    });
                }, 10*i);
            });
            $('.header-menu-close').removeClass('pointer-events');
        });      
        ...
        $('.header-menu-close').click(function(){
            $('.header-menu a').each(function(i){
                var row = $(this);
                setTimeout(function() {
                    row.removeClass('header-menu-inactive-'+i);
                }, 40*i);
            });
      ...
      var options = {
        ...
        onStart: {
          ...
          render: function ($container) {
            ...
            $('#page-content, .header, .footer-menu-open, .scrolling-menu-fixed').css({
            ...
            $('.header-menu, .header-menu-background, .scrolling-menu-fixed').css({
                "opacity":"0",
